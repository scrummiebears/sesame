...
def home():
    ...
    for prop in user_proposals:
        if prop.approved == "APPROVED":
            ...
            rejected.append(prop)
            rejectedNum += 1
    return render_template('auth/home.html',title="Statistics",navs=navs,approved=approved,pending_reviewNum=pending_reviewNum,editNum=editNum,pending_adminNum=pending_adminNum,edit=edit,rejected=rejected,pending_review=pending_review,pending_admin=pending_admin,approvedNum=approvedNum,rejectedNum=rejectedNum)
